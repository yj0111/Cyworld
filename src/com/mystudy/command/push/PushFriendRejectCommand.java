...
public class PushFriendRejectCommand implements Command {

	@Override
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

		System.out.println("PushFriendRejectCommand 진입");
		...
		int result = PushDAO.insertFriendReject(userCode1, userCode2);
