...
public class FriendDeleteCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = FriendDAO.deleteFriend(userCode, opponentCode);
		
		if (result <=0) {
			System.err.println("친구 삭제도중 에러 발생:: 관리자 확인 요망");
		}
		
		String path = "mainLoadController?userCode="+userCode+"&visitHost="+userCode;
