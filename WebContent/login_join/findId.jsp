...
<body>
<div id="find" class="cyworldfindid">
	<div style="text-align : center;">
	<p><img src="cyworld.png" alt="싸이월드 로고" width="350px" height="75px" ></p>
	</div>
	
	<form name="frm" action="UserController?type=findId" method="post">
	<table>
		<tbody>
			<tr>
				<th>성명</th>
		...
		<tfoot>
			<tr>
				<td colspan="2">
				    <input type ="button" class="button" style="width:260px;height:40px; font-size:1em;" onclick="check_form()" value="아이디찾기">
    			</td>
    		</tr>
		</tfoot>
	</table>
